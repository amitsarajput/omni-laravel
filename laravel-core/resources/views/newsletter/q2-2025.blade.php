<x-guest-layout>
    ...
    <!-- Page Title
    ============================================= -->
    <x-page-title image-url="{{ asset('images/newsletter/q2-2025/banner.webp') }}" container="true" page-title="{!!__('aboutPage__title')!!}" class="page-title--center el-height-70 uppercase" />

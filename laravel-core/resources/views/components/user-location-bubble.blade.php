...
<div {{ $attributes->merge(['class' => $classes]) }}>
	...
	<div class="location-bubble--inner">
		<div class="location-bubble--col bubble-text">@lang('You are currently viewing the :language website. If you wish to change the region, please select it from the drop-down list.', ['language'=>$location_locale[$location]])</div>

            ...
            <div class="grid grid-bleed align-center">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="ma-xxs-2 ma-xs-2 ma-sm-2 ma-md-2 mx-lg-7">
                        ...
                        <p>Olli Seppälä, Head of R&D, leads the charge in engineering tyres that combine state-of-the-art materials and advanced manufacturing techniques. His vision is to deliver premium quality through a global network—without the premium price.</p>
            ...
            <div class="grid grid-bleed align-center">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="ma-xxs-2 mx-lg-7">
                        ...
                        <p>Test driver Stephane Clepkens pushes every Radar tyre to the limit, rejecting anything that doesn’t outperform expectations. His mission? To ensure Radar Tyres rival and even surpass premium brands in real-world performance.</p>
                        <a class="knopf red heading-font sharp ls-1" href="{{ route('pages.why-radar') }}">READ MORE</a>
                        <a class="knopf red heading-font sharp ls-1" href="{{ route('pages.why-radar') }}">WATCH VIDEO</a>
                        <!-- <h5 class="black">DIMAX SPORT | DIMAX SPRINT | DIMAX ALL SEASON | DIMAX WINTER</h5> -->
                    </div>
            ...
            <div class="grid grid-bleed align-center">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="ma-xxs-2 ma-xs-2 ma-sm-2 ma-md-2 mx-lg-7">
                        ...
                        <p>Legendary automotive designers Giorgetto and Fabrizio Giugiaro (GFG Style) bring the same ethos of luxury car design to Radar Tyres. Their philosophy? High-end aesthetics and performance shouldn’t be reserved for a select few but should be accessible to every driver.</p>
                        <a class="knopf link heading-font ls-1" href="{{ route('pages.why-radar') }}">READ MORE</a>
                        <a class="knopf red heading-font sharp ls-1" href="{{ route('pages.why-radar') }}">WATCH VIDEO</a>
                        <!-- <h5 class="black">DIMAX SPORT | DIMAX SPRINT | DIMAX ALL SEASON | DIMAX WINTER</h5> -->
                    </div>
                </div>

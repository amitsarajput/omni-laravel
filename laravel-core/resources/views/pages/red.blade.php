            ...
            <div class="grid">
                <div class="col-md-12 center">
                    <div class="pa-2" style="background-color: #00000061;">
                        ...
                        <a target="_blank" 
                        @if(session('omni_data.country')!=null && session('omni_data.country')=='es')
                            href="https://youtu.be/haekaIqITu8"
                        @else
                            href="https://youtu.be/4fysR3vaiYA"
                        @endif
                         class="knopf red sharp uppercase hover-black-80 heading-font ls-2 my-1" >{{__('WATCH RED INTRODUCTION VIDEO')}}</a>
                    </div>
                </div>
            </div>
            <div class="grid">
            ...
            <div class="container">
                <div class="grid ">
                    <div class="col-md-12 center">
                        ...
                        @else
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/4fysR3vaiYA?si=Z6s5Dm_TNQsB1mpC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        @endif
                    </div>
                </div>
            </div>

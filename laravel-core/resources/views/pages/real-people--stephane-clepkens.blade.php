<x-guest-layout>
    ...
    <section id="content" class="pb-4">
        <div class="container">
            ...
            <div class="grid">
                <div class="col-md-12">
                    <h4 class="dark-100 uppercase">{{ __("Joining Radar Tyres: a new chapter") }}</h4>
                    <p>{{ __("Stéphane’s decision to join Radar Tyres was driven by the company’s progressive approach. “Radar Tyres impressed me with their flat, horizontal management structure and the freedom they offer to innovate,” Stéphane shares. “Their mission to deliver premium-level performance at accessible prices aligns perfectly with my vision of democratising tyre safety and quality.”")}}</p>
                </div>
                <div class="col-md-12">
                    <h4 class="dark-100 uppercase">{{ __("A unique philosophy on tyre testing") }}</h4>
                    <p>{{ __("For Stéphane, real-world testing is at the heart of tyre development. “Tyres are complex and highly technical products,” he explains. “Their performance can only be truly understood under real driving conditions, where we transform subjective customer feedback into objective targets for research and development.”") }}</p>
                </div>
                <div class="col-md-12">
                    <h4 class="dark-100 uppercase">{{ __("Redefining premium") }}</h4>
                    <p>{{ __("Stéphane’s mission at Radar Tyres is clear: to elevate the brand to premium status while ensuring that its products remain affordable for all. “Every market is different, and in Europe, I know what customers and carmakers expect from their tyres,” he says. “Reaching premium standards requires targeting the same benchmarks as the established leaders, but we’re committed to achieving this without compromising on cost-effectiveness.”") }} </p>
                </div>
                <div class="col-md-12">
                    <h4 class="dark-100 uppercase">{{ __("Making safety accessible") }}</h4>
                    <p>{{ __("Stéphane’s passion extends beyond performance metrics to the broader impact of his work. “Tyres are the only points of contact between a car and the road,” he notes. “Democratising premium tyre performance means providing young drivers, retirees, and everyone in between with access to safe, reliable products.”") }}</p>
                </div>
                <div class="col-md-12">
